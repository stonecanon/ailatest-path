  ...
  <section class="search-shell">
    ...
    <form class="filters" id="filters">
      <label>
        ...
        <input id="query" type="search" placeholder="School, city, state, program" data-i18n-placeholder="searchPlaceholder">
      </label>
      <label>
