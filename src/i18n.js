const translations = {
  en: {
    ...
    homeIntro: "Explore 200 public U.S. colleges by annual cost, accreditation and F-1 evidence, outcomes, and student experience links.",
    homeTitle: "Compare U.S. colleges.",
    higherCost: "Higher Cost",
    insurance: "Insurance",
    introCostText: "Tuition, living estimate, and annual total",
    introCostTitle: "Cost",
    introEvidenceText: "Accreditation, DAPIP, and SEVP/F-1 evidence",
    introEvidenceTitle: "Legitimacy",
    introExperienceText: "School-specific searches across five social platforms",
    introExperienceTitle: "Student experience",
    introFootnote: "Filter first, then open a school page to check sources and student experiences.",
  ...
  zh: {
    ...
    graduation: "毕业率",
    homeIntro: "用年度费用、学校资质、F-1/SEVP 证据、毕业结果和学生体验，筛选 200 所美国公立院校。",
    homeTitle: "比较美国院校。",
    higherCost: "较高成本",
    insurance: "保险",
    introCostText: "学费、生活费估算与年度总成本",
    introCostTitle: "费用",
    introEvidenceText: "认证、DAPIP 与 SEVP/F-1 证据",
    introEvidenceTitle: "资质",
    introExperienceText: "小红书、YouTube 等五个平台的学校体验入口",
    introExperienceTitle: "学生体验",
    introFootnote: "先筛选，再进入学校详情核对来源和学生体验。",
