const translations = {
  en: {
    ...
    homeIntro: "Use the filters to build a shortlist, then open each school page to confirm current tuition, F-1 eligibility, admissions requirements, and program details.",
    homeTitle: "Compare U.S. colleges by cost, legitimacy checks, programs, and graduation outcomes.",
  ...
  zh: {
    ...
    graduation: "毕业率",
    homeIntro: "先用筛选器建立选校清单，再进入学校页面核对最新学费、F-1 资格、申请要求和专业信息。",
    homeTitle: "按费用、正规性核查、专业和毕业结果比较美国院校。",
    higherCost: "较高成本",
    insurance: "保险",
